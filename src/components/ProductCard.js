  ...
  return (
    ...
    >
      {pathname.includes("cart") && (
        <div className="bg-indigo-500 rounded-full absolute w-10 h-10 grid place-items-center">
      ...
      <div className="flex gap-2 mt-5">
        {pathname.includes("cart") && (
          <button
            ...
            className=" bg-orange-500 rounded-full py-1 px-2 flex-1 text-white text-bold"
          >
            remove
          </button>
        )}
